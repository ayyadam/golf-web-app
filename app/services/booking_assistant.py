...
class LLMIntentExtractor(ABC):
    ...
    def _system_prompt(today: date) -> str:
        ...
        return (
            ...
            "Set not_before and/or not_after ONLY when the member states an explicit "
            "clock time; otherwise leave BOTH null. Never derive them from the words "
            "'morning' or 'afternoon' — those set period only.\n"
            ...
            "  'saturday morning' (no clock time) -> not_before null, not_after null\n"
